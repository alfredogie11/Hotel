...
<head>
  <meta charset="UTF-8">
  <title>BARCIE CENTER ADMIN</title>
...
<body style="background-color: #e4eef3;">
 ...
 <div class="container" style="display: flex;">
      ...
      <div id="login">
            <h1 style="padding: 1rem;text-align:center;font-size:1.3rem">ADMIN LOGIN</h3>
        <form method="post">
    ...
    <!-- <div class="bottom">  <h3><a href="../index.php">BARCI CENTER HOMEPAGE</a></h3></div> -->
